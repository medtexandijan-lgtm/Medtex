...
class SaleAdmin(admin.ModelAdmin):
    list_display = ('id', 'client', 'seller', 'shift', 'total_amount', 'status', 'created_at')
    list_filter = ('status', 'seller', 'shift')
    search_fields = ('id', 'client__name', 'seller__username', 'seller__first_name', 'seller__last_name')
    inlines = [SaleItemInline]


@admin.register(SellerShift)
class SellerShiftAdmin(admin.ModelAdmin):
    list_display = ('seller', 'started_at', 'ended_at', 'is_open')
    list_filter = ('seller',)
