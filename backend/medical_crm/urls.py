...
urlpatterns = [
    ...
    path('supplier/products/', views.supplier_legacy_redirect, name='legacy_supplier_products'),
    path('supplier/supplies/create/', views.supplier_legacy_redirect, name='legacy_supplier_supply_create'),
    path('supplier/supplies/', views.supplier_legacy_redirect, name='legacy_supplier_supplies'),
    path('supplier/deliveries/', views.supplier_deliveries, name='supplier_deliveries'),
    path('supplier/deliveries/<int:pk>/', views.supplier_delivery_detail, name='supplier_delivery_detail'),
    path('supplier/deliveries/<int:pk>/complete/', views.supplier_delivery_complete, name='supplier_delivery_complete'),
