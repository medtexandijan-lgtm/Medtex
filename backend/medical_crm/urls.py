...
urlpatterns = [
    ...
    path('users/<int:pk>/shift/start/', views.seller_shift_start, name='seller_shift_start'),
    path('users/<int:pk>/shift/end/', views.seller_shift_end, name='seller_shift_end'),
