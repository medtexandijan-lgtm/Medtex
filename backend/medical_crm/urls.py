...
urlpatterns = [
    ...
    path('supplier/supplies/create/', views.supplier_supply_create, name='supplier_supply_create'),
    path('supplier/supplies/', views.supplier_supplies, name='supplier_supplies'),
